...
export class EditComponent implements OnInit {
  ...
  private updateEmittedValue(searchResponse: Search) {
    if (searchResponse.id) {
      switch (searchResponse.actionType) {
        case ActionType.ViewProject: this.getProjectsDetails(searchResponse); break;
        case ActionType.ViewUser: this.getUserDetails(searchResponse); break;
      }
    }
  ...
  private getUserDetails(searchResponse: Search) {
  ...
  private getProjectsDetails(searchResponse: Search) {
